...
(function(global2, factory) {
  ...
  */
  ...
  const text = "";
  const view = "";
  const LotteryMachine_vue_vue_type_style_index_0_scoped_5a1dd0a0_lang = "";
    ...
    methods: {
      ...
      init({
        ...
        if (typeof duration !== "number") {
          ...
          duration = isNaN(duration) ? 4e3 : duration;
        }
      ...
      setTranslateY(results) {
        ...
        for (let i = 0, len = results.length; i < len; i++) {
          if (this.direction == "up") {
            ...
            for (let k = 0, len2 = this.shaftList[i].length; k < len2; k++) {
              if (this.shaftList[i][k].value == results[i]) {
                res.results.push(
                  JSON.parse(JSON.stringify(this.shaftList[i][k]))
                );
      ...
      shuffle(arr) {
        ...
        for (let i = 1; i < tmpArr.length; i++) {
          ...
          [tmpArr[i], tmpArr[random2]] = [tmpArr[random2], tmpArr[i]];
        }
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", { class: "shell" }, [
      vue.createElementVNode("div", { class: "l" }, [
        vue.createCommentVNode(" 小灯列表 "),
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($data.lamps, (item, index) => {
      ...
      vue.createElementVNode("div", { class: "c" }, [
        vue.createElementVNode("div", { class: "HMSM" }, [
          vue.createCommentVNode(" 背景 "),
          vue.createElementVNode("div", { class: "HMSM-display-bg" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.shaftList, (shaft, index) => {
          ...
          vue.createElementVNode("div", { class: "HMSM-display" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList($data.shaftList, (shaft, index) => {
                return vue.openBlock(), vue.createElementBlock(
                  ...
                  {
                    key: index,
                    class: vue.normalizeClass(["HMSM-shaft", { roll_animation: $data.rollState == "start" }]),
                    style: vue.normalizeStyle({
                      transform: "translate3d(0, " + $data.translateY[index] + "%, 0)",
                      "transition-duration": $data.duration + "ms"
                    })
                  },
                  [
                    (vue.openBlock(true), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(shaft, (item, shaftIndex) => {
                        return vue.openBlock(), vue.createBlock(
      ...
      vue.createElementVNode("div", { class: "r" }, [
        vue.createCommentVNode(" 小灯列表 "),
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
  ...
  const LotteryMachine = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-5a1dd0a0"]]);
  const uniLotteryCard_vue_vue_type_style_index_0_scoped_bb8dcf3d_lang = "";
  const _sfc_main = {
    ...
    computed: {
      prizeList() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.prizeList || this.defaultPrizeList;
      },
      prizeResult() {
        return this.componentProperties && this.componentProperties.data && this.componentProperties.data.prizeResult;
      }
    },
    components: {
      // 注册组件
    ...
    methods: {
      startLottery() {
        const curResult = this.prizeResult || this.getResults();
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_LotteryMachine = vue.resolveComponent("LotteryMachine");
    const _component_v_uni_text = index$i;
    return vue.openBlock(), vue.createElementBlock("div", { class: "content" }, [
      vue.createElementVNode("div", { class: "sm" }, [
        vue.createVNode(
          _component_LotteryMachine,
          { ref: "LotteryMachine" },
          null,
          512
          /* NEED_PATCH */
      ...
      vue.createElementVNode("div", {
        class: "start",
        onClick: _cache[0] || (_cache[0] = vue.withModifiers((...args) => $options.startLottery && $options.startLottery(...args), ["stop"]))
      }, [
        vue.createVNode(_component_v_uni_text, { class: "start-text" }, {
          default: vue.withCtx(() => [
            vue.createTextVNode("抽奖")
          ]),
          _: 1
          /* STABLE */
        })
  ...
  const UniLotteryCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-bb8dcf3d"]]);
